...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch SHRNet Example')
...
parser.add_argument('--model', type=str, default='GANet_R', help="model to train")
